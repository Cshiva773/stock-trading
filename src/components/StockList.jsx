...
const baseURL="https://finnhub.io/api/v1/quote?symbol=MSFT&token=cgc4811r01qispgnol20cgc4811r01qispgnol2g"
        ...
        {stock.map((stockData)=>{
          return(
            <tr style={{cursor:"pointer"}} onClick={()=>handleStockSelect(stockData.symbol)} className='table-row' key={stockData.symbol}>
              <th scope="row">{stockData.symbol}<button className="btn btn-danger btn-sm ml-3 d-inline-block delete-button" onClick={(e)=>{
              e.stopPropagation()
